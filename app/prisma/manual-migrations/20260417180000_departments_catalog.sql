...
-- COPY THIS FILE TO: prisma/migrations/20260417200000_departments_catalog/migration.sql
-- (folder must be writable — use sudo/chown if needed), then deploy runs `prisma migrate deploy`.
--
